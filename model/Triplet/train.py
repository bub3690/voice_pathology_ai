...
def main():
    ...
    parser.add_argument('--wandb',type=bool, default=False,
                        help='Use wandb log')                        
    parser.add_argument('--model',type=str, default='wav_res_triplet',
                        help='list : [baseline,wav_res_triplet]') #모델들 수정 필요
    ...
    parser.add_argument("--probs", type=float, default=0.0, help="online learning 확률")
