...
from Dataset.Dataset import svd_dataset,load_data
...
def main():
    ...
    if args.wandb:
        ...
        wandb_run_name = args.model+'_'+args.name+'_norm_'+args.normalize
    ...
    X_train_list, X_valid_list, X_test, Y_train_list, Y_valid_list, Y_test = cv_spliter(random_state)        
    ...
    data_instance = PhraseData("../voice_data/organics/phrase_sig_dict.pickle") #class에 데이터를 담아준다.
